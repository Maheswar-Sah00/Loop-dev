...
import { handleMessageIngest } from './message-ingest.js';
...
export function register(app) {
  ...
  // Separate top-level-channel-message ingestion/classification (no Slack output).
  app.event('message', handleMessageIngest);
}
